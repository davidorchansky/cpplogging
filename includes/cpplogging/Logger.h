...
namespace cpplogging {
  ...
  public:
    ...
    inline void Debug(Targs... Fargs)
    {
      Log->debug(Fargs...);
    }
    template<typename... Targs>
    inline void Error(Targs... Fargs)
    {
      Log->error(Fargs...);
    }
    template<typename... Targs>
    inline void Info(Targs... Fargs)
    {
      Log->info(Fargs...);
    }
    template<typename... Targs>
    inline void Trace(Targs... Fargs)
    {
      Log->trace(Fargs...);
    }
    template<typename... Targs>
    inline void Warn(Targs... Fargs)
    {
      Log->warn(Fargs...);
    }
    template<typename... Targs>
    inline void Critical(Targs... Fargs)
    {
      Log->critical(Fargs...);
    }
  };
